...
INSERT INTO tools (name, slug, canonical_name, company_name, website_url, short_description, long_description, open_source, self_hostable, api_available, tool_type, lifecycle_status, founded_year, status_active) VALUES
  ('ChatGPT',        'chatgpt',        'ChatGPT',        'OpenAI',       'https://chatgpt.com',              'Multimodal LLM with vision, voice, and enterprise data connectors.',                                                               false, false, true,  'saas',        'active', 2022, true),
  ('Claude',         'claude',         'Claude',         'Anthropic',    'https://claude.ai',                'Long-context reasoning model prized for careful analysis over hallucination.',                                                    false, false, true,  'saas',        'active', 2023, true),
  ('Perplexity AI',  'perplexity-ai',  'Perplexity AI',  'Perplexity',   'https://perplexity.ai',            'Real-time search engine with citations and follow-up questions.',                                                                 false, false, true,  'saas',        'active', 2022, true),
  ('Google Gemini',  'google-gemini',  'Google Gemini',  'Google',       'https://gemini.google.com',        'Multimodal model tied to Google apps for live data analysis.',                                                                    false, false, true,  'saas',        'active', 2023, true),
  ('Grok',           'grok',           'Grok',           'xAI',          'https://grok.x.ai',                'Reasoning model with native real-time X data for startup intelligence.',                                                         false, false, true,  'saas',        'active', 2023, true),
  ('Microsoft Copilot','microsoft-copilot','Microsoft Copilot','Microsoft','https://copilot.microsoft.com', 'Enterprise LLM embedded in Excel, PowerPoint, and Teams.',                                                                        false, false, true,  'saas',        'active', 2023, true),
  ('Poe',            'poe',            'Poe',            'Quora',        'https://poe.com',                  'Multi-model aggregator switching between Claude, GPT, and Gemini instantly.',                                                    false, false, false, 'saas',        'active', 2022, true),
  ('HuggingChat',    'huggingchat',    'HuggingChat',    'Hugging Face', 'https://huggingface.co/chat',      'Open-source model runner for privacy-sensitive or custom fine-tuned workloads.',                                                 true,  true,  false, 'open_source', 'active', 2023, true),
  ('DeepSeek R1',    'deepseek-r1',    'DeepSeek R1',    'DeepSeek',     'https://deepseek.com',             'Fast, cheap reasoning model for bulk research and first-draft code.',                                                             false, false, true,  'saas',        'active', 2024, true),
  ('Bing Chat',      'bing-chat',      'Bing Chat',      'Microsoft',    'https://bing.com/chat',            'Free web-integrated chat for quick daily lookups and image generation.',                                                          false, false, false, 'saas',        'active', 2023, true),
  ('Otio',           'otio',           'Otio',           'Otio',         'https://otio.com',                 'AI research summarizer that turns papers and podcasts into structured notes.',                                                    false, false, false, 'saas',        'active', 2022, true),
  ('Silatus',        'silatus',        'Silatus',        'Silatus',      'https://silatus.com',              'Enterprise-grade research agent for internal docs and web intelligence reports.',                                                 false, false, false, 'saas',        'active', 2023, true),
  ('Flowith',        'flowith',        'Flowith',        'Flowith',      'https://flowith.io',               'Research agent that builds living knowledge bases from customer calls and docs.',                                                 false, false, false, 'saas',        'active', 2023, true),
  ('NotebookLM',     'notebooklm',     'NotebookLM',     'Google',       'https://notebooklm.google.com',    'Audio and summary engine for uploaded docs, turning them into podcast-style briefings.',                                         false, false, false, 'saas',        'active', 2023, true),
  ('Perplexity Computer','perplexity-computer','Perplexity Computer','Perplexity','https://perplexity.ai/computer','End-to-end workflow agent for automating research-to-report pipelines.',                                                   false, false, false, 'saas',        'active', 2025, true)
ON CONFLICT (slug) DO NOTHING;
...
INSERT INTO tools (name, slug, canonical_name, company_name, website_url, short_description, long_description, github_url, open_source, self_hostable, api_available, tool_type, lifecycle_status, founded_year, status_active) VALUES
  ('Cursor IDE',       'cursor-ide',       'Cursor IDE',       'Anysphere',     'https://cursor.com',                  'VS Code fork with deep codebase understanding and multi-file Composer mode.',                              NULL,                                           false, false, false, 'saas',        'active', 2023, true),
  ('Claude Code',      'claude-code',      'Claude Code',      'Anthropic',     'https://claude.ai/code',              'Agentic coder that reads your repo, plans, edits files, and runs terminal commands.',                     NULL,                                           false, false, true,  'saas',        'active', 2024, true),
  ('GitHub Copilot Pro','github-copilot-pro','GitHub Copilot Pro','GitHub',      'https://github.com/features/copilot', 'Inline code completion and chat in IDE for boilerplate generation.',                                    NULL,                                           false, false, false, 'saas',        'active', 2021, true),
  ('Replit',           'replit',           'Replit',           'Replit',        'https://replit.com',                  'Browser-based autonomous app builder with 30+ integrations for non-coders.',                            NULL,                                           false, false, true,  'saas',        'active', 2016, true),
  ('Windsurf',         'windsurf',         'Windsurf',         'Codeium',       'https://codeium.com/windsurf',        'Cursor competitor focused on vibe coding speed for rapid feature iteration.',                            NULL,                                           false, false, false, 'saas',        'active', 2024, true),
  ('v0',               'v0',               'v0',               'Vercel',        'https://v0.dev',                      'AI UI component generator outputting production-ready shadcn/Tailwind + Next.js.',                       NULL,                                           false, false, true,  'saas',        'active', 2023, true),
  ('Lovable',          'lovable',          'Lovable',          'Lovable',       'https://lovable.dev',                 'Prompt-to-full-stack React app builder with DB, auth, and hosting included.',                           NULL,                                           false, false, false, 'saas',        'active', 2024, true),
  ('Bolt.new',         'bolt-new',         'Bolt.new',         'StackBlitz',    'https://bolt.new',                    'Browser-based full-stack app generator that deploys instantly across frameworks.',                       NULL,                                           false, false, false, 'saas',        'active', 2024, true),
  ('Factory',          'factory',          'Factory',          'Factory AI',    'https://factory.ai',                  'Autonomous coding agent for repetitive tasks and legacy codebase maintenance.',                          NULL,                                           false, false, false, 'saas',        'active', 2023, true),
  ('Codex',            'codex',            'Codex',            'OpenAI',        'https://platform.openai.com/codex',   'Next-gen coding agent for one-shot complex module generation.',                                         NULL,                                           false, false, true,  'api',         'active', 2021, true),
  ('Spawn.co',         'spawn-co',         'Spawn.co',         'Spawn',         'https://spawn.co',                    'Game and app builder for interactive prototypes and quick validation MVPs.',                             NULL,                                           false, false, false, 'saas',        'active', 2024, true),
  ('Codeium',          'codeium',          'Codeium',          'Codeium',       'https://codeium.com',                 'Fast, free inline code completion alternative for everyday development.',                                NULL,                                           false, false, false, 'saas',        'active', 2022, true),
  ('Continue.dev',     'continue-dev',     'Continue.dev',     'Continue',      'https://continue.dev',                'Open-source Cursor alternative for self-hosted and privacy-first setups.',                              'https://github.com/continuedev/continue',      true,  true,  false, 'open_source', 'active', 2023, true),
  ('Qodo',             'qodo',             'Qodo',             'Qodo',          'https://qodo.ai',                     'Test-focused coding agent for auto-generating unit tests at scale.',                                    NULL,                                           false, false, false, 'saas',        'active', 2023, true),
  ('Base44',           'base44',           'Base44',           'Base44',        'https://base44.com',                  'Rapid prototype agent for full apps targeting non-dev founders.',                                       NULL,                                           false, false, false, 'saas',        'active', 2024, true),
  ('Emergent',         'emergent',         'Emergent',         'Emergent',      'https://emergent.sh',                 'AI agent that builds and iterates apps end-to-end from a prompt.',                                      NULL,                                           false, false, false, 'saas',        'active', 2024, true),
  ('Manus',            'manus',            'Manus',            'Manus AI',      'https://manus.ai',                    'Autonomous dev agent for complex multi-step workflows.',                                                 NULL,                                           false, false, false, 'saas',        'active', 2024, true),
  ('n8n',              'n8n',              'n8n',              'n8n',           'https://n8n.io',                      'Self-hosted visual automation with custom code nodes for internal tools and agents.',                   'https://github.com/n8n-io/n8n',                true,  true,  true,  'open_source', 'active', 2019, true),
  ('Nebula',           'nebula',           'Nebula',           'Nebula',        'https://nebula.io',                   'Cloud-based coding collaborator for solo teams.',                                                        NULL,                                           false, false, false, 'saas',        'active', 2023, true),
  ('Testim',           'testim',           'Testim',           'Tricentis',     'https://testim.io',                   'AI test automation platform for end-to-end testing.',                                                   NULL,                                           false, false, false, 'saas',        'active', 2015, true)
ON CONFLICT (slug) DO NOTHING;

-- Group 3: App & Website Builders
INSERT INTO tools (name, slug, canonical_name, company_name, website_url, short_description, open_source, self_hostable, api_available, tool_type, lifecycle_status, founded_year, status_active) VALUES
  ('Dora',        'dora',        'Dora',        'Dora',        'https://dora.run',        '3D and AI website builder with animations for immersive landing pages.',       false, false, false, 'saas', 'active', 2022, true),
  ('10Web',       '10web',       '10Web',       '10Web',       'https://10web.io',        'AI WordPress site generator and optimizer for fast launches.',                  false, false, false, 'saas', 'active', 2017, true),
  ('Framer',      'framer',      'Framer',      'Framer',      'https://framer.com',      'AI-powered site and interaction builder for high-converting landing pages.',    false, false, false, 'saas', 'active', 2014, true),
  ('Durable',     'durable',     'Durable',     'Durable',     'https://durable.co',      'Instant AI website from one prompt for same-day client site launches.',         false, false, false, 'saas', 'active', 2021, true),
  ('Wegic',       'wegic',       'Wegic',       'Wegic',       'https://wegic.ai',        'Conversational AI web builder for prompt-driven site creation.',                false, false, false, 'saas', 'active', 2024, true),
  ('Glide',       'glide',       'Glide',       'Glide',       'https://glideapps.com',   'No-code apps from spreadsheets, turning Google Sheets into customer portals.',  false, false, false, 'saas', 'active', 2018, true),
  ('Adalo',       'adalo',       'Adalo',       'Adalo',       'https://adalo.com',       'Mobile app builder with AI-assisted logic and design.',                         false, false, false, 'saas', 'active', 2018, true),
  ('Bubble',      'bubble',      'Bubble',      'Bubble',      'https://bubble.io',       'Visual logic and AI generation for complex SaaS products without code.',        false, false, true,  'saas', 'active', 2012, true),
  ('Softr',       'softr',       'Softr',       'Softr',       'https://softr.io',        'AI dashboards from Airtable and Supabase data for client portals.',             false, false, false, 'saas', 'active', 2020, true),
  ('Webflow',     'webflow',     'Webflow',     'Webflow',     'https://webflow.com',     'Professional sites with AI copy and layout for designers and marketers.',       false, false, true,  'saas', 'active', 2013, true),
  ('Design.com',  'design-com',  'Design.com',  'Design.com',  'https://design.com',      'AI brand and site generator for instant brand identity creation.',              false, false, false, 'saas', 'active', 2022, true),
  ('Super AI',    'super-ai',    'Super AI',    'Super',       'https://super.ai',        'All-in-one site and app AI agent for prompt-driven creation.',                  false, false, false, 'saas', 'active', 2024, true)
ON CONFLICT (slug) DO NOTHING;

-- Group 4: Design & Image Generation
INSERT INTO tools (name, slug, canonical_name, company_name, website_url, short_description, github_url, open_source, self_hostable, api_available, tool_type, lifecycle_status, founded_year, status_active) VALUES
  ('Midjourney',     'midjourney',     'Midjourney',     'Midjourney',      'https://midjourney.com',          'Best-in-class image gen via Discord for product mockups, ads, and branding.',    NULL,                                              false, false, false, 'saas',        'active', 2022, true),
  ('Leonardo AI',    'leonardo-ai',    'Leonardo AI',    'Leonardo AI',     'https://leonardo.ai',             'Fine-tuned image model for consistent styles and UI concept generation.',         NULL,                                              false, false, true,  'saas',        'active', 2022, true),
  ('Flux',           'flux',           'Flux',           'Black Forest Labs','https://blackforestlabs.ai',     'Open high-quality image model for free and local runs on IP-sensitive work.',    'https://github.com/black-forest-labs/flux',       true,  true,  true,  'open_source', 'active', 2024, true),
  ('Recraft',        'recraft',        'Recraft',        'Recraft',         'https://recraft.ai',              'Vector and illustration specialist AI for brand-consistent visuals.',             NULL,                                              false, false, true,  'saas',        'active', 2023, true),
  ('Adobe Firefly',  'adobe-firefly',  'Adobe Firefly',  'Adobe',           'https://firefly.adobe.com',       'Enterprise-safe image generation inside Photoshop and Creative Cloud.',           NULL,                                              false, false, true,  'saas',        'active', 2023, true),
  ('Canva Magic Studio','canva-magic-studio','Canva Magic Studio','Canva',   'https://canva.com',               'Everyday design with AI fill and magic edit for complete social content kits.',  NULL,                                              false, false, false, 'saas',        'active', 2012, true),
  ('Freepik AI',     'freepik-ai',     'Freepik AI',     'Freepik',         'https://freepik.com',             'Stock and custom AI-generated images for marketing and design.',                  NULL,                                              false, false, false, 'saas',        'active', 2010, true),
  ('Stylar',         'stylar',         'Stylar',         'Stylar',          'https://stylar.ai',               'Style transfer specialist for consistent brand visual identity.',                 NULL,                                              false, false, false, 'saas',        'active', 2023, true),
  ('Clipdrop',       'clipdrop',       'Clipdrop',       'Stability AI',    'https://clipdrop.co',             'Background removal and object generation for clean product visuals.',             NULL,                                              false, false, true,  'saas',        'active', 2020, true),
  ('Looka',          'looka',          'Looka',          'Looka',           'https://looka.com',               'AI logos and brand asset generator for solopreneurs and startups.',              NULL,                                              false, false, false, 'saas',        'active', 2016, true),
  ('Namelix',        'namelix',        'Namelix',        'Namelix',         'https://namelix.com',             'AI-powered business name and domain combo generator.',                            NULL,                                              false, false, false, 'saas',        'active', 2017, true),
  ('Brandmark',      'brandmark',      'Brandmark',      'Brandmark',       'https://brandmark.io',            'Professional logo generator with complete brand system output.',                  NULL,                                              false, false, false, 'saas',        'active', 2016, true),
  ('Stockimg AI',    'stockimg-ai',    'Stockimg AI',    'Stockimg',        'https://stockimg.ai',             'Custom AI-generated stock images at scale for content teams.',                    NULL,                                              false, false, false, 'saas',        'active', 2022, true),
  ('Galileo AI',     'galileo-ai',     'Galileo AI',     'Galileo',         'https://usegalileo.ai',           'UI/UX concept generator from text prompts for rapid design exploration.',        NULL,                                              false, false, false, 'saas',        'active', 2022, true),
  ('Bing Create',    'bing-create',    'Bing Create',    'Microsoft',       'https://bing.com/create',         'Free quick AI image generation integrated into Bing.',                            NULL,                                              false, false, false, 'saas',        'active', 2023, true),
  ('Autodraw',       'autodraw',       'Autodraw',       'Google',          'https://autodraw.com',            'Sketch-to-vector AI drawing tool for quick concept visualization.',               NULL,                                              false, false, false, 'saas',        'active', 2017, true),
  ('Designs AI',     'designs-ai',     'Designs AI',     'Designs.ai',      'https://designs.ai',              'Full branding kits with AI including logo, video, and mockups.',                  NULL,                                              false, false, false, 'saas',        'active', 2019, true),
  ('Vance AI',       'vance-ai',       'Vance AI',       'Vance AI',        'https://vanceai.com',             'AI image upscaling and enhancement for sharper visuals.',                        NULL,                                              false, false, true,  'saas',        'active', 2019, true)
ON CONFLICT (slug) DO NOTHING;

-- Group 5: Video & Audio Creation
INSERT INTO tools (name, slug, canonical_name, company_name, website_url, short_description, open_source, self_hostable, api_available, tool_type, lifecycle_status, founded_year, status_active) VALUES
  ('HeyGen',         'heygen',         'HeyGen',         'HeyGen',         'https://heygen.com',         'AI avatars and talking-head videos for personalized demos without cameras.',            false, false, true,  'saas', 'active', 2020, true),
  ('ElevenLabs',     'elevenlabs',     'ElevenLabs',     'ElevenLabs',     'https://elevenlabs.io',      'Voice cloning and TTS for explainer videos, podcasts, and multilingual content.',       false, false, true,  'saas', 'active', 2022, true),
  ('Runway ML',      'runway-ml',      'Runway ML',      'Runway',         'https://runwayml.com',       'Text-to-video and editing suite for product demos and social clips.',                    false, false, true,  'saas', 'active', 2018, true),
  ('Kling AI',       'kling-ai',       'Kling AI',       'Kuaishou',       'https://klingai.com',        'High-quality motion video generation from text and image prompts.',                      false, false, false, 'saas', 'active', 2024, true),
  ('Luma Dream Machine','luma-dream-machine','Luma Dream Machine','Luma AI','https://lumalabs.ai',       'Dream-like video generation from text and images.',                                      false, false, true,  'saas', 'active', 2021, true),
  ('Sora',           'sora',           'Sora',           'OpenAI',         'https://openai.com/sora',    'OpenAI flagship text-to-video model for cinematic AI video generation.',                 false, false, true,  'saas', 'active', 2024, true),
  ('Veo 2',          'veo-2',          'Veo 2',          'Google DeepMind','https://deepmind.google/veo','Advanced video generation integrated with Gemini for professional use.',                  false, false, false, 'saas', 'active', 2024, true),
  ('Pika',           'pika',           'Pika',           'Pika Labs',      'https://pika.art',           'Quick social video clip generator from text or image inputs.',                           false, false, false, 'saas', 'active', 2023, true),
  ('Pictory',        'pictory',        'Pictory',        'Pictory',        'https://pictory.ai',         'Text-to-video from scripts and blog posts for content repurposing.',                    false, false, false, 'saas', 'active', 2021, true),
  ('Synthesia',      'synthesia',      'Synthesia',      'Synthesia',      'https://synthesia.io',       'Avatar video at scale for L&D and marketing without camera crews.',                     false, false, true,  'saas', 'active', 2017, true),
  ('InVideo',        'invideo',        'InVideo',        'InVideo',        'https://invideo.io',         'Template and AI video editing platform for social and marketing content.',               false, false, false, 'saas', 'active', 2019, true),
  ('Opus Clip',      'opus-clip',      'Opus Clip',      'Opus Clip',      'https://opus.pro',           'Long video to viral shorts auto-editor for social media growth.',                        false, false, false, 'saas', 'active', 2023, true),
  ('Descript',       'descript',       'Descript',       'Descript',       'https://descript.com',       'Audio and video editing with voice cloning and overdub capabilities.',                   false, false, false, 'saas', 'active', 2017, true),
  ('Lovo AI',        'lovo-ai',        'Lovo AI',        'Lovo AI',        'https://lovo.ai',            'Multi-voice text-to-speech generation for content creators.',                           false, false, true,  'saas', 'active', 2019, true),
  ('Adobe Podcast',  'adobe-podcast',  'Adobe Podcast',  'Adobe',          'https://podcast.adobe.com',  'AI audio enhancement and noise removal for professional-quality podcasts.',              false, false, false, 'saas', 'active', 2022, true),
  ('CapCut AI',      'capcut-ai',      'CapCut AI',      'ByteDance',      'https://capcut.com',         'Mobile-first video editor with AI effects for social content.',                          false, false, false, 'saas', 'active', 2019, true)
ON CONFLICT (slug) DO NOTHING;

-- Group 6: Writing & Content Creation
INSERT INTO tools (name, slug, canonical_name, company_name, website_url, short_description, open_source, self_hostable, api_available, tool_type, lifecycle_status, founded_year, status_active) VALUES
  ('Jasper AI',      'jasper-ai',      'Jasper AI',      'Jasper',         'https://jasper.ai',          'Long-form marketing content generation at enterprise scale.',                            false, false, true,  'saas', 'active', 2021, true),
  ('Writesonic',     'writesonic',     'Writesonic',     'Writesonic',     'https://writesonic.com',     'SEO-optimized copy and chat for marketing teams.',                                       false, false, true,  'saas', 'active', 2021, true),
  ('Copy AI',        'copy-ai',        'Copy AI',        'Copy.ai',        'https://copy.ai',            'Short-form sales copy and GTM workflow automation.',                                     false, false, true,  'saas', 'active', 2020, true),
  ('Rytr',           'rytr',           'Rytr',           'Rytr',           'https://rytr.me',            'Budget-friendly AI writer for common marketing and content use cases.',                  false, false, true,  'saas', 'active', 2021, true),
  ('Textblaze',      'textblaze',      'Textblaze',      'Textblaze',      'https://textblaze.me',       'Snippet expansion and text automation for repetitive writing tasks.',                   false, false, false, 'saas', 'active', 2019, true),
  ('HIX AI',         'hix-ai',         'HIX AI',         'HIX AI',         'https://hix.ai',             'All-in-one AI writer for articles, emails, and varied content types.',                  false, false, true,  'saas', 'active', 2022, true),
  ('Jenny AI',       'jenny-ai',       'Jenny AI',       'Jenny AI',       'https://jenny.ai',           'Personalized AI content and academic writing assistant.',                               false, false, false, 'saas', 'active', 2021, true),
  ('QuillBot',       'quillbot',       'QuillBot',       'QuillBot',       'https://quillbot.com',       'Paraphrasing, summarizing, and grammar checking for polished writing.',                  false, false, false, 'saas', 'active', 2017, true),
  ('Grammarly',      'grammarly',      'Grammarly',      'Grammarly',      'https://grammarly.com',      'Real-time editing, tone analysis, and business writing improvement.',                   false, false, true,  'saas', 'active', 2009, true),
  ('Surfer SEO',     'surfer-seo',     'Surfer SEO',     'Surfer',         'https://surferseo.com',      'Content optimizer with AI writing and NLP keyword analysis.',                           false, false, false, 'saas', 'active', 2017, true),
  ('Anyword',        'anyword',        'Anyword',        'Anyword',        'https://anyword.com',        'Predictive performance scoring for marketing copy variants.',                           false, false, true,  'saas', 'active', 2013, true),
  ('Hoppy Copy',     'hoppy-copy',     'Hoppy Copy',     'Hoppy Copy',     'https://hoppycopy.co',       'Email and ad copy specialist for high-converting campaigns.',                           false, false, false, 'saas', 'active', 2021, true),
  ('SurgeGraph',     'surgegraph',     'SurgeGraph',     'SurgeGraph',     'https://surgegraph.io',      'Long-form SEO article generator for content marketing teams.',                          false, false, false, 'saas', 'active', 2022, true),
  ('Sudowrite',      'sudowrite',      'Sudowrite',      'Sudowrite',      'https://sudowrite.com',      'Creative and long-form fiction writing AI for authors.',                                 false, false, false, 'saas', 'active', 2020, true),
  ('AdCreative AI',  'adcreative-ai',  'AdCreative AI',  'AdCreative.ai',  'https://adcreative.ai',      'Ad variant generator with AI-powered performance predictions.',                         false, false, true,  'saas', 'active', 2021, true),
  ('Predis AI',      'predis-ai',      'Predis AI',      'Predis',         'https://predis.ai',          'Social and ad content generator with built-in scheduling.',                             false, false, true,  'saas', 'active', 2021, true),
  ('JotBot',         'jotbot',         'JotBot',         'JotBot',         'https://myjotbot.com',       'Note-to-content AI writing assistant for structured drafts.',                           false, false, false, 'saas', 'active', 2022, true)
ON CONFLICT (slug) DO NOTHING;

-- Group 7: Productivity & Automation
INSERT INTO tools (name, slug, canonical_name, company_name, website_url, short_description, github_url, open_source, self_hostable, api_available, tool_type, lifecycle_status, founded_year, status_active) VALUES
  ('Notion AI',        'notion-ai',        'Notion AI',        'Notion',      'https://notion.so',          'Second brain with databases and AI writing — founders keep entire company ops here.',   NULL,                                      false, false, true,  'saas',        'active', 2016, true),
  ('Zapier',           'zapier',           'Zapier',           'Zapier',      'https://zapier.com',         'No-code automation connecting every tool in solo founder stacks.',                       NULL,                                      false, false, true,  'saas',        'active', 2011, true),
  ('Make',             'make',             'Make',             'Make',        'https://make.com',           'Complex visual automation workflows for advanced multi-step integrations.',               NULL,                                      false, false, true,  'saas',        'active', 2012, true),
  ('Bardeen AI',       'bardeen-ai',       'Bardeen AI',       'Bardeen',     'https://bardeen.ai',         'Browser automation agents for eliminating repetitive research and data tasks.',          NULL,                                      false, false, false, 'saas',        'active', 2020, true),
  ('ClickUp Brain',    'clickup-brain',    'ClickUp Brain',    'ClickUp',     'https://clickup.com',        'AI-powered task and project management with natural language commands.',                  NULL,                                      false, false, true,  'saas',        'active', 2017, true),
  ('Motion',           'motion',           'Motion',           'Motion',      'https://usemotion.com',      'AI calendar and tasks that auto-schedule your day for maximum focus.',                    NULL,                                      false, false, false, 'saas',        'active', 2019, true),
  ('Clockwise',        'clockwise',        'Clockwise',        'Clockwise',   'https://getclockwise.com',   'Team scheduling AI that optimizes focus time and reduces meeting fragmentation.',         NULL,                                      false, false, false, 'saas',        'active', 2017, true),
  ('Granola',          'granola',          'Granola',          'Granola',     'https://granola.so',         'AI meeting note taker for Mac with automatic action item extraction.',                   NULL,                                      false, false, false, 'saas',        'active', 2023, true),
  ('Relay.app',        'relay-app',        'Relay.app',        'Relay',       'https://relay.app',          'Agent-powered workflow automation with human-in-the-loop steps.',                        NULL,                                      false, false, false, 'saas',        'active', 2022, true),
  ('Gumloop',          'gumloop',          'Gumloop',          'Gumloop',     'https://gumloop.com',        'No-code AI agent builder for scraping, processing, and automating data flows.',          NULL,                                      false, false, false, 'saas',        'active', 2024, true),
  ('Stack AI',         'stack-ai',         'Stack AI',         'Stack AI',    'https://stack-ai.com',       'Enterprise AI workflow builder with LLM chains and API deployment.',                     NULL,                                      false, false, true,  'saas',        'active', 2023, true),
  ('Voiceflow',        'voiceflow',        'Voiceflow',        'Voiceflow',   'https://voiceflow.com',      'Conversational AI agent builder for product teams and developers.',                       NULL,                                      false, false, true,  'saas',        'active', 2019, true),
  ('Botpress',         'botpress',         'Botpress',         'Botpress',    'https://botpress.com',       'Open-source chatbot and agent builder with self-hosting support.',                        'https://github.com/botpress/botpress',    true,  true,  true,  'open_source', 'active', 2016, true),
  ('Xembly',           'xembly',           'Xembly',           'Xembly',      'https://xembly.com',         'AI chief of staff for meetings, scheduling, and action item tracking.',                  NULL,                                      false, false, false, 'saas',        'active', 2020, true),
  ('Jotform AI Agents','jotform-ai-agents','Jotform AI Agents','Jotform',     'https://jotform.com',        'Form-to-workflow automation with AI agents for data collection and routing.',             NULL,                                      false, false, true,  'saas',        'active', 2006, true),
  ('PrometAI',         'prometai',         'PrometAI',         'PrometAI',    'https://prometai.app',       'Business forecasting and strategic planning AI for founders.',                            NULL,                                      false, false, false, 'saas',        'active', 2023, true),
  ('HockeyStack',      'hockeystack',      'HockeyStack',      'HockeyStack', 'https://hockeystack.com',    'Product analytics and revenue attribution automation for B2B SaaS.',                     NULL,                                      false, false, true,  'saas',        'active', 2020, true),
  ('Siift AI',         'siift-ai',         'Siift AI',         'Siift',       'https://siift.ai',           'Startup strategy and market intelligence agent for early-stage founders.',               NULL,                                      false, false, false, 'saas',        'active', 2024, true),
  ('Cofounder AI',     'cofounder-ai',     'Cofounder AI',     'Cofounder',   'https://cofounder.ai',       'Personal AI business advisor for startup founders at every stage.',                       NULL,                                      false, false, false, 'saas',        'active', 2023, true),
  ('Zovoro AI',        'zovoro-ai',        'Zovoro AI',        'Zovoro',      'https://zovoro.com',         'All-in-one growth dashboard with AI insights for scaling startups.',                      NULL,                                      false, false, false, 'saas',        'active', 2024, true)
ON CONFLICT (slug) DO NOTHING;

-- Group 8: Marketing & Sales
INSERT INTO tools (name, slug, canonical_name, company_name, website_url, short_description, open_source, self_hostable, api_available, tool_type, lifecycle_status, founded_year, status_active) VALUES
  ('HubSpot AI',     'hubspot-ai',     'HubSpot AI',     'HubSpot',       'https://hubspot.com',        'Full CRM with content and AI sales sequences for scaling startups.',                      false, false, true,  'saas', 'active', 2006, true),
  ('Qualified',      'qualified',      'Qualified',      'Qualified',     'https://qualified.com',      'AI-powered lead qualification and pipeline intelligence for revenue teams.',               false, false, true,  'saas', 'active', 2018, true),
  ('Drift',          'drift',          'Drift',          'Salesloft',     'https://drift.com',          'Conversational marketing and sales automation for inbound pipeline.',                      false, false, true,  'saas', 'active', 2015, true),
  ('Outreach',       'outreach',       'Outreach',       'Outreach',      'https://outreach.io',        'AI sales sequences and revenue intelligence for enterprise sales teams.',                  false, false, true,  'saas', 'active', 2014, true),
  ('Typefully',      'typefully',      'Typefully',      'Typefully',     'https://typefully.com',      'X thread writer and scheduler for founder growth and audience building.',                  false, false, false, 'saas', 'active', 2020, true),
  ('Postwise',       'postwise',       'Postwise',       'Postwise',      'https://postwise.ai',        'AI X post writer and growth tool for consistent social presence.',                         false, false, false, 'saas', 'active', 2022, true),
  ('Taplio',         'taplio',         'Taplio',         'Taplio',        'https://taplio.com',         'LinkedIn and X growth AI for personal branding and lead generation.',                     false, false, false, 'saas', 'active', 2021, true),
  ('Hypefury',       'hypefury',       'Hypefury',       'Hypefury',      'https://hypefury.com',       'Content repurposing and X scheduling for social media growth.',                            false, false, false, 'saas', 'active', 2019, true),
  ('TweetHunter',    'tweethunter',    'TweetHunter',    'TweetHunter',   'https://tweethunter.io',     'AI thread ideas and X growth tool for viral content creation.',                           false, false, false, 'saas', 'active', 2021, true),
  ('Buffer AI',      'buffer-ai',      'Buffer AI',      'Buffer',        'https://buffer.com',         'Multi-platform social media scheduler with AI content suggestions.',                       false, false, true,  'saas', 'active', 2010, true),
  ('Hootsuite AI',   'hootsuite-ai',   'Hootsuite AI',   'Hootsuite',     'https://hootsuite.com',      'Enterprise social media management with AI publishing and analytics.',                    false, false, true,  'saas', 'active', 2008, true),
  ('Metricool',      'metricool',      'Metricool',      'Metricool',     'https://metricool.com',      'Analytics and AI content suggestions for social media optimization.',                     false, false, true,  'saas', 'active', 2016, true),
  ('Simplified',     'simplified',     'Simplified',     'Simplified',    'https://simplified.com',     'All-in-one design and marketing content platform with AI writing.',                       false, false, false, 'saas', 'active', 2021, true),
  ('Tribescaler',    'tribescaler',    'Tribescaler',    'Tribescaler',   'https://tribescaler.com',    'Community growth and viral hook AI for X and social media.',                              false, false, false, 'saas', 'active', 2022, true),
  ('Howler AI',      'howler-ai',      'Howler AI',      'Howler',        'https://howlerai.com',       'Voice and ad specialist for growth marketers and performance campaigns.',                  false, false, false, 'saas', 'active', 2023, true),
  ('Emplifi',        'emplifi',        'Emplifi',        'Emplifi',       'https://emplifi.io',         'Enterprise email and social AI platform for unified customer engagement.',                 false, false, true,  'saas', 'active', 2010, true),
  ('Pencil',         'pencil',         'Pencil',         'Pencil',        'https://trypencil.com',      'AI ad creative generator and optimizer for performance marketing.',                       false, false, true,  'saas', 'active', 2018, true)
ON CONFLICT (slug) DO NOTHING;

-- Group 9: Meetings, Notes & Transcription
INSERT INTO tools (name, slug, canonical_name, company_name, website_url, short_description, open_source, self_hostable, api_available, tool_type, lifecycle_status, founded_year, status_active) VALUES
  ('Fireflies AI',  'fireflies-ai',  'Fireflies AI',  'Fireflies',  'https://fireflies.ai',   'AI meeting transcription with action items and semantic search.',              false, false, true,  'saas', 'active', 2016, true),
  ('Otter AI',      'otter-ai',      'Otter AI',      'Otter',      'https://otter.ai',       'Real-time meeting notes with search and team collaboration.',                  false, false, true,  'saas', 'active', 2016, true),
  ('tl;dv',         'tldv',          'tl;dv',         'tl;dv',      'https://tldv.io',        'Clip, summarize, and share meeting highlights for async review.',              false, false, true,  'saas', 'active', 2021, true),
  ('Avoma',         'avoma',         'Avoma',         'Avoma',      'https://avoma.com',      'AI meeting assistant with coaching, scorecards, and full transcription.',      false, false, true,  'saas', 'active', 2017, true),
  ('Krisp',         'krisp',         'Krisp',         'Krisp',      'https://krisp.ai',       'Noise cancellation plus AI meeting notes and conversation insights.',          false, false, false, 'saas', 'active', 2018, true),
  ('Noty AI',       'noty-ai',       'Noty AI',       'Noty',       'https://noty.ai',        'Smart AI note taker for meetings with automatic summaries.',                   false, false, false, 'saas', 'active', 2022, true),
  ('MeetGeek',      'meetgeek',      'MeetGeek',      'MeetGeek',   'https://meetgeek.ai',    'Meeting intelligence with highlights, scoring, and team sharing.',             false, false, true,  'saas', 'active', 2020, true)
ON CONFLICT (slug) DO NOTHING;
...
VALUES
  ...
  ((SELECT id FROM tools WHERE slug='cursor-ide'),
   ...
   false, false, false, ARRAY['code','text'], ARRAY['code'], ARRAY['github','gitlab','vercel']),
  ...
  ((SELECT id FROM tools WHERE slug='claude-code'),
   ...
   ARRAY['developer','technical-founder'], ARRAY['mvp','growth'],
   true, false, false, ARRAY['code','text','repository'], ARRAY['code','files','terminal-output'], ARRAY['github','vercel']),
  ...
  ((SELECT id FROM tools WHERE slug='bolt-new'),
   ...
   false, false, false, ARRAY['text','code'], ARRAY['app','code'], ARRAY['netlify','vercel','github']),
  ...
  ((SELECT id FROM tools WHERE slug='v0'),
   ...
   true, false, false, ARRAY['text','image'], ARRAY['code','component'], ARRAY['vercel','nextjs','github']),
...
INSERT INTO tools (name, slug, canonical_name, company_name, website_url, short_description, long_description, github_url, open_source, self_hostable, api_available, tool_type, lifecycle_status, founded_year, status_active) VALUES
  ...
  ('Vercel',      'vercel',      'Vercel',      'Vercel',      'https://vercel.com',              'Frontend hosting and edge platform with serverless functions, Postgres, KV, and blob storage.',          'Beyond hosting — Vercel provides serverless functions, edge middleware, Postgres (via Neon), KV store, and blob storage. Native deployment target for Next.js, SvelteKit, and v0-generated apps. Many pair Vercel frontend + Supabase/Convex backend; Vercel storage primitives handle simple data needs without adding extra services.',                                                          NULL,                                              false, false, true,  'saas',        'active', 2015, true),
  ('Neon',        'neon',        'Neon',        'Neon',        'https://neon.tech',               'Serverless Postgres with branching, autoscaling, and built-in vector support for AI and RAG apps.',      'Serverless Postgres with branching, autoscaling, and AI vector support. X devs love branching for safe, zero-risk migrations in Cursor workflows — spin up a branch, test the schema change, merge. The database engine powering Vercel Postgres, also used standalone with Next.js and Drizzle.',                                                                                             NULL,                                              false, false, true,  'saas',        'active', 2021, true),
...
VALUES
  ...
  ((SELECT id FROM tools WHERE slug='vercel'),      'default', (SELECT id FROM pricing_models WHERE slug='freemium'),   true,  20.00, 'seat_based',  20.00,   80.00, false, 'Hobby free; Pro $20/user/mo; Enterprise custom',                                     'https://vercel.com/pricing'),
...
VALUES
  ...
  ((SELECT id FROM tools WHERE slug='vercel'),
  ...
  ((SELECT id FROM tools WHERE slug='neon'),
   ...
   ARRAY['technical-founder','developer'], ARRAY['mvp','growth','scale'],
   true, false, true, ARRAY['sql'], ARRAY['database','vector'], ARRAY['vercel','drizzle','prisma','cursor','next-js','langchain']),
...
VALUES
  ...
  ((SELECT id FROM tools WHERE slug='vercel'),      'website',    'https://vercel.com',                                true),
  ((SELECT id FROM tools WHERE slug='vercel'),      'pricing',    'https://vercel.com/pricing',                        false),
  ((SELECT id FROM tools WHERE slug='vercel'),      'docs',       'https://vercel.com/docs',                           false),
...
VALUES
  ...
  ((SELECT id FROM tools WHERE slug='vercel'),      (SELECT id FROM categories WHERE slug='backend-infra'),   1.0000, 'manual', true),
  ((SELECT id FROM tools WHERE slug='vercel'),      (SELECT id FROM categories WHERE slug='website-builder'),  0.6000, 'manual', false),
...
VALUES
  ...
  -- Vercel
  ((SELECT id FROM tools WHERE slug='vercel'),   (SELECT id FROM capabilities WHERE slug='deployment_platform'),    1.0, 'manual', 'strong'),
  ((SELECT id FROM tools WHERE slug='vercel'),   (SELECT id FROM capabilities WHERE slug='edge_functions'),          1.0, 'manual', 'strong'),
  ((SELECT id FROM tools WHERE slug='vercel'),   (SELECT id FROM capabilities WHERE slug='managed_postgres'),        0.8, 'manual', 'moderate'),
  ((SELECT id FROM tools WHERE slug='vercel'),   (SELECT id FROM capabilities WHERE slug='vector_search'),           0.6, 'manual', 'basic'),
  -- Neon
...
VALUES
  ...
  ((SELECT id FROM tools WHERE slug='vercel'),          0, 11000, 9600, 0.96, now()),
...
VALUES
  ...
  -- Vercel vs others
  ((SELECT id FROM tools WHERE slug='vercel'),     (SELECT id FROM tools WHERE slug='render'),      'cheaper',    true,  false, false, 'Lower cost, full-stack hosting including non-JS backends'),
  ((SELECT id FROM tools WHERE slug='vercel'),     (SELECT id FROM tools WHERE slug='railway'),     'cheaper',    true,  false, false, 'Zero-config deploys with plugin ecosystem; very friendly UI'),
  ((SELECT id FROM tools WHERE slug='vercel'),     (SELECT id FROM tools WHERE slug='fly-io'),      'cheaper',    true,  false, false, 'More control and global edge with container-level customization'),
  -- Render vs Railway/Fly
  ((SELECT id FROM tools WHERE slug='render'),     (SELECT id FROM tools WHERE slug='vercel'),      'easier',     false, false, false, 'Best for Next.js and frontend-heavy apps; edge functions included'),
